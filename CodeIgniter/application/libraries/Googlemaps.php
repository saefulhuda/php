...
class Googlemaps {
	...
	var $apiKey						= 'AIzaSyAsi4AocAJTXahLBHoHYjTmWx0v_Jjq2Q8'; 						// If you've got an API key you can use it by passing this parameter. Setup an API key here: https://code.google.com/apis/console
